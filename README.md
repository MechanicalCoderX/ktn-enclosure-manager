...
docker compose down && docker rmi ghcr.io/mechanicalcoderx/ktn-enclosure-manager:1.2.8
```
...
PYTHONPATH=backend .venv/bin/python -m pytest tests/ -q      # 268 tests, no hardware needed
