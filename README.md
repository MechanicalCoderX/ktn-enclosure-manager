...
docker compose down && docker rmi ghcr.io/mechanicalcoderx/ktn-enclosure-manager:1.2.6
```
...
PYTHONPATH=backend .venv/bin/python -m pytest tests/ -q      # 266 tests, no hardware needed
